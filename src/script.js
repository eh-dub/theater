...
import {listStoreUpdates} from './utils/';
...
export function *script(productStore) {
  ...
  const updateProducts = listStoreUpdates(productStore);
  ...
  let productUpdates = updateProducts(products
                                     , (p, i) => i >= 1
  ...
  productUpdates = updateProducts( products
                                 , (p, i) => true
